package com.codurs.meetroulette.authenticator;
...
import com.codurs.meetroulette.util.SafeAsyncTask;
...
public class LogoutService {
    ...
    private static class LogoutTask extends SafeAsyncTask<Boolean> {
        ...
        public Boolean call() throws Exception {
            ...
            final Account[] accounts = AccountManager.get(context).getAccountsByType(Constants.Auth.MOOWE_ACCOUNT_TYPE);
